...
class RenderRow extends Component {
  ...
  addFunds(acctN, fromAddy) {
    var fundsToAdd = (function ask() {
      var n = prompt(
        "Please enter how many wei to add\n1000000000000000000 wei is 1 eth"
      );
    ...
    return (
      <div className="row">
        ...
        <div className="col-4 col-solid">
          <button
            onClick={() =>
              this.changeOwner(this.props.account.key, this.state.inputValue)
            }
          >
            Change owner
          </button>
          <button
            onClick={() =>
              this.addFunds(this.props.account.key, this.props.verifiedAddress)
            }
          >
            Add Funds
          </button>
